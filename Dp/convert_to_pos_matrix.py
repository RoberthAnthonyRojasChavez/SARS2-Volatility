...
'''
# Inputs ================================================================================================
working_dir = r"U:\ResearchData\rdss_hhaim\LAB PROJECTS\Anthony\NCBI\Spatial_relationship\6zgi\\"
in_csv_name = "Matrix.csv"
out_csv_name = "Matrix_6zgi_pos.csv"

# output matrix format (NOTE: range(1,6) means [1,2,3,4,5], doesn't cover 6)
position_range = list(range(1, 1274))# + list(range(512, 665))
# ========================================================================================================
