...
# ==========================================================================================
working_dir = r"U:\ResearchData\rdss_hhaim\LAB PROJECTS\Anthony\September_SARS\For tree\\"
seq_filename = r"AA_alldelta_nw.csv"
group_filename = r"Group_Delta_50s.txt"
output_filename = r"AA_DeltaG.csv"
threshold = ""  # for naming the group
season = ''  # for naming the group  e.g.: '14-15'

accession_attribute_name = 'Accession'  # this is the name of accession attribute appears in the sequence file
# ==========================================================================================
