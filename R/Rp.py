...
@author: Changze Han modified by R. Anthony Rojas Chavez
"""
    ...
    HIV Project: 
        ...
        calculation process: 
            for each row in log-Long-Vol:
                ...
                This returns Rp with a Sum rather than Average
...
# Inputs ================================================================================================
working_dir = r"U:\ResearchData\rdss_hhaim\LAB PROJECTS\Anthony\NCBI\Rooted_Tree\Tree\Predict_branches\Predict_G0,G3,G4,G5,G6,G8,G10,Eta,Kappa,Beta\Compare_prediction_G0\G0_without_Terminal\10.27.21 Depleted Alpha\\"
fisher_input_filename = "Matrix_6zgi_6_reci.csv"
longVol_input_filename = "test_stdev_G0no_ter_log.csv"
output_filename = "Rp_sum.csv"

position_range = (1, 1273)
# ========================================================================================================
    ...
    for row in longVol_list[1:]:  # exclude header row
        ...
        for p_target in position_list:
            ...
            if len(fisher_pairs) != 0:
                ...
                current_p_netVol = current_p_netVol
