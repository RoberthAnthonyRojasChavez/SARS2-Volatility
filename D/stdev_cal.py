...
# ==========================================================================================
working_dir = r"U:\ResearchData\rdss_hhaim\LAB PROJECTS\Anthony\NCBI\Rooted_Tree\Tree\Time\Branch_timeaware\Before_Sep_19_2020\Time_no_branch\\"
#r"/Users/Han/Documents/Haim_Lab(2018_summer)/9.25.19_new_accession(H1N1_USA)/06-19_season/season_FDs/"
seq_filename = r"AA_w_Accession_w_Groups_50_Oct - Copy.csv"
...
#option 2:
group_attribute_name = 'Group' #'Patient-Days'#'Group'  # this is the name of group attribute appears in the sequence file
#option 3:
