...
'''
    ...
    Algorithms: 
        ...
        4. Compare the 100,000 avg distance t with the true value T: 
            4.a. calculate how many times t are smaller than the T? 
'''
# Inputs ================================================================================================
working_dir = r"U:\ResearchData\rdss_hhaim\SARS-CoV-2 Sequence and Data Library\Deep sequence\4.6\\"
#r"/Users/Han/Documents/Haim_Lab(2018_summer)/3.9.20_Orange/"
in_csv_name = "Data for permutation delimited 4.csv"
...
shuffle_col = 1  # shuffle identifiers is at this col (will be shuffled)(starts at index 0)
pos_start = 2  # position starts at this col (starts at index 0)
# ========================================================================================================
